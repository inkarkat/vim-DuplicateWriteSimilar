...
call EditSimilar#CommandBuilder#SimilarFileOperations('DuplicateWrite', 'DuplicateWrite<bang>', 1, 1, {'omitOperationsWorkingOnlyOnExistingFiles': 1, 'completeAnyRoot': 1, 'OptionParser': function('DuplicateWriteSimilar#OptionParser')})
